...
class UpdatePassengers(Frame):
    ...
    def handle_update(self):
        ...
        result = db_controller.update_passenger(
        ...
        if result:
            ...
            messagebox.showerror("Error", "Failed to update pssassenger. Please Verify that all IDs are correct.")
