...
class ViewPassengers(Frame):
    ...
    def handle_delete(self):
        if db_controller.delete_passengers(self.parent.selected_rid):
            messagebox.showinfo("Successfully Deleted the passenger")
        else:
            messagebox.showerror("Unable to delete passenger")
