...
class AddLounges(Frame):
    ...
    def save(self):
        ...
        # Save the room
        result = db_controller.add_lounge(
            *[self.data[label].get() for label in ("r_no", "price", "type")]
        )

        if result:
            messagebox.showinfo("Success", "lounge added successfully")
            ...
            messagebox.showerror(
                "Error", "Unable to add lounge. Please make sure the data is validated"
            )
